...
(function($) {
    $.fn.verticaltabs = function(options) {
        ...
        return this.each(function() {
            ...
            $(".verticalslider_tabs a", verticaltabs).click(function() {
                if (!$(this).parent().hasClass("activeTab")) {
                    ...
                    if (slideShow) {
                        ...
                        slideShow = false;
                        $(".pause a", verticaltabs).css("visibility", "hidden");
                        $(".play a", verticaltabs).css("visibility", "visible")
                    }
                }
                return false
            });
            ...
            setTimeout(function() { contents.not('.activeContent').css('display','none');},200);
        })
    }
})(jQuery);*/