...
var E_STYLE_0 = new EStyle("/_layouts/15/images/Sazmanyar.GIS/GoogleMap/Stem/stem7.png", new GSize(1, 1), "estyle2", new GPoint(1, 1));
var E_STYLE_1 = new EStyle("/_layouts/15/images/Sazmanyar.GIS/GoogleMap/Stem/stem1.png", new GSize(81, 87), "estyle1", new GPoint(-30, 87 - 3));
var E_STYLE_2 = new EStyle("/_layouts/15/images/Sazmanyar.GIS/GoogleMap/Stem/stem2.png", new GSize(81, 87), "estyle2", new GPoint(-30, 87 - 1));
var E_STYLE_3 = new EStyle("/_layouts/15/images/Sazmanyar.GIS/GoogleMap/Stem/stem3.png", new GSize(81, 87), "estyle3", new GPoint(-30, 87 - 10));
var E_STYLE_4 = new EStyle("/_layouts/15/images/Sazmanyar.GIS/GoogleMap/Stem/stem3.png", new GSize(81, 87), "estyle4", new GPoint(-30, 87 - 10));
var E_STYLE_5 = new EStyle("/_layouts/15/images/Sazmanyar.GIS/GoogleMap/Stem/stem1.png", new GSize(81, 87), "estyle5", new GPoint(-30, 87 - 3));
var E_STYLE_6 = new EStyle("/_layouts/15/images/Sazmanyar.GIS/GoogleMap/Stem/stem6.png", new GSize(100, 50), "estyle6", new GPoint(100 - 2, 20));
var E_STYLE_7 = new EStyle("/_layouts/15/images/Sazmanyar.GIS/GoogleMap/Stem/stem7.png", new GSize(24, 24), "estyle2", new GPoint(-10, 23));
