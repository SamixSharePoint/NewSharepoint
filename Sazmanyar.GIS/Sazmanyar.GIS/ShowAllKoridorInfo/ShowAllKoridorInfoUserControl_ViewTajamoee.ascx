...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShowAllKoridorInfoUserControl_NewTajamoee.ascx.cs" Inherits="Sazmanyar.GIS.ShowAllKoridorInfo.ShowAllKoridorInfoUserControl_NewTajamoee" %>
<style type="text/css">
    #s4-leftpanel
    {
        display: none;
