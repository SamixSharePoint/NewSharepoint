...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShowAllKoridorInfoUserControl_ViewTemplate3.ascx.cs" Inherits="Sazmanyar.GIS.ShowAllKoridorInfo.ShowAllKoridorInfoUserControl_ViewTemplate3" %>
<style type="text/css">
    #s4-leftpanel {
        display: none;
    }
...
<script type="text/javascript" language="javascript">
    ...
    function RefereshReportsLinks() {
        ...
        var NameProjeh = getchlSelectedValues(document.getElementById(X('.NameProjeh').attr('ID')));
        ...
        X.ajax({
            ...
            success: function (strHtmlOutput) {
                ...
                if (NameProjeh != getchlSelectedValues(document.getElementById(X('.NameProjeh').attr('ID')))) {
                    //Not Continue
                    return;
                }
    ...
    function InitializeFilterInMap() {
        ...
        var NameProjeh = "";
        NameProjeh = getchlSelectedValues(document.getElementById(X('.NameProjeh').attr('ID')));
    ...
    function ButtonSearchClicked() {
        ...
        if (getchlSelectedValues(document.getElementById(X('.NameProjeh').attr('ID'))).trim().length == 0) {
            alert("جهت جستجو انتخاب نام پروژه الزامی است");
            return;
        }
                        ...
                        <div class="gis-topbar">
                            <div class="gis-fields">
                                ...
                                <div class="gis-field">
                                    ...
                                    <asp:RadioButtonList ID="chbProgramName" class="NameProjeh" runat="server"
...
<script type="text/javascript">
    ...
    if (GBrowserIsCompatible()) {
        ...
        var map;
        var request;
        var bounds = new GLatLngBounds(new GLatLng(39.027719, 44.736328), new GLatLng(26.745610, 62.050781)); // Iran
        var geonamesUrl;
        var earthtoolsUrl;
        var addFile = false;
        var debug = false;
