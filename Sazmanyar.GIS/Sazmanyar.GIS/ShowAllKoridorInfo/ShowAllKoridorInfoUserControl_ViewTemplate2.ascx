...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShowAllKoridorInfoUserControl_ViewTemplate2.ascx.cs" Inherits="Sazmanyar.GIS.ShowAllKoridorInfo.ShowAllKoridorInfoUserControl_ViewTemplate2" %>
...
<script type="text/javascript" language="javascript">
    ...
    if (typeof ($) != 'undefined') {
        $(document).ready(function () {
            ...
            X.ajax({
                type: "POST",
                url: strCurrentWebUrl + "/_layouts/15/Sazmanyar.GIS/ApplicationPage_FetchingData.aspx/FillSugestion_ProjectNameDistinctInfoDataBase",
                data: "{}",
    ...
    function FetchRecursiveAllCoridorInfoFromDataBase(NameProjeh, Condition, PageSize, PageIndex) {
        if (PageIndex == 1) {
            bounds = bounds = new GLatLngBounds(new GLatLng(39.027719, 44.736328), new GLatLng(26.745610, 62.050781)); // Iran
        }
